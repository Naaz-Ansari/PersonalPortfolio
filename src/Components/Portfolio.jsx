...
const projectList = [
  {
    ...
    description:
      "A secure and personalized notes-taking app with speech to text converter. Key features: Create notes with recording voice, copy, add to favourite, and delete notes.",
